         ...
         <Modal footer={null} title={null} closable={false} visible={props.visible}>
                <div className="change-pwd-dlg">
                    ...
                    <Form  requiredMark={false} className="password-form" labelCol={{span:4}} colon={false} form={pwdForm}>
                        <Form.Item help={passwordHelpMsg} validateStatus={passwordValidate} name="password" label={'原密码'} rules={[{ required: true, message: '请输入密码' }]}>
                        ...
                        <Form.Item  help={confirmHelpMsg} validateStatus={confirmValidate} name={"confirmPassword"} label={'确认密码'} rules={[{ required: true, message: '请再次输入新密码' }]}>
                            <Input onFocus={response.clearError} type={"password"}/>
                        </Form.Item>
                    </Form>
