                ...
                ? (
                    <div>
                        <div className="d-flex justify-end mb10">
                            <EffButton onClick={response.cancelEditing} text="取消" key="cancel" round width={80} type="line" />
                            <EffButton className="ml10" onClick={response.saveContent} text="保存" key="save" round width={80} type="filled" />
                        </div>
