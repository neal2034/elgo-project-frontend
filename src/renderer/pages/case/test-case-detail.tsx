        ...
        <div className="pt40 pl40 pr40 pb40">
            ...
            <div style={{marginLeft:'60px'}}>
                <div className="d-flex align-center mt20">
                    <EffLabel name={'所属功能'}/>
                    <EffEditableSelector id={currentTestCase.funztionId}  onSearch={response.handleSearchFunztion} searchAble={true} options={filterFunztion} onChange={response.handleFunztionChange}/>
