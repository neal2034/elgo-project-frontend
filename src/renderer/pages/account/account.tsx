...
export enum AccountPageStatus { LOGIN, FORGET_PWD, FORGET_MAIL_SEND, RESET_PWD, INVALID, WAIT}
...
export default function Account(props: IAccountProps) {
    ...
    useEffect(() => {
        if (initStatus === AccountPageStatus.RESET_PWD) {
            dispatch(accountThunks.checkRetrievePwdToken({ token })).then((result) => {
                if (result.isSuccess) {
                    setTitle('重置密码')
        ...
        <div className="account">
            <div className="content-wrap">
                ...
                <div className="content mt20">
                    ...
                    { status === AccountPageStatus.FORGET_PWD && (
                        <ForgetPwd
                            backLogin={handlers.goLogin}
                            sentForgetPwdEmail={handlers.sentForgetPwdEmail}
                        />
                    ) }
