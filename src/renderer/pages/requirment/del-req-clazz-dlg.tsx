    ...
    return (
        <div className="del-req-clazz-dlg d-flex-column">
            ...
            <div className="mt20 d-flex justify-end">
                <EffButton onClick={onCancel} width={80} text="取消" key="cancel" round type="line" />
                <EffButton onClick={onConfirm} width={80} className="ml10" text="删除" key="delete" round type="filled" />
            </div>
        </div>
    );
}
